...
(
  ...
  ACCOUNT    NVARCHAR2(24),
  SIGNTOKEN  NVARCHAR2(32),
...
(
  ...
  DISABLEDATE DATE,
  CONSTRAINTS PK_USER_ROLE_REL_ID PRIMARY KEY(ROLEID,USERID) USING INDEX TABLESPACE tbs_pk_idx,
...
(
  ...
  CONSTRAINTS PK_WEIXIN_USER PRIMARY KEY (WEIXINID) USING INDEX TABLESPACE tbs_pk_idx,
...
(
  ID      NVARCHAR2(36) NOT NULL,
  ACCOUNT NVARCHAR2(24) NOT NULL UNIQUE,
  PASSWORD NVARCHAR2(32) NOT NULL,
  BUSINESSID  NVARCHAR2(36) NOT NULL,
  POST NVARCHAR2(16),
  NAME NVARCHAR2(16) NOT NULL,
...
--用户购买记录表 MB_USER_PURCHASE_RECORD
--删除表 DROP TABLE MB_USER_PURCHASE_RECORD CASCADE CONSTRAINTS;
CREATE TABLE MB_USER_PURCHASE_RECORD
(
  ID         NVARCHAR2(36) NOT NULL,  
  ORDERNO    NVARCHAR2(36) NOT NULL,
  REFUNDID   NVARCHAR2(36),
  BUSINESSID NVARCHAR2(36),
  FLAGSHIPID NVARCHAR2(36),
  USERID     NVARCHAR2(36) NOT NULL,
  PRICE      NUMBER(16,2) NOT NULL,
  VOLUMN     NUMBER(16,2) NOT NULL,
  CLEAR      NUMBER(16,2) NOT NULL,
  BACKVOLUMN NUMBER(16,2) NOT NULL,
  CREATEDATE DATE DEFAULT SYSDATE,
  STATUS     NUMBER(1) NOT NULL,
  CONSTRAINTS PK_USER_PURCHASE_ID PRIMARY KEY (ID) USING INDEX 
);
/
...
--商户提现记录表
CREATE TABLE MB_BUSINESS_WITHDRAW
(
  ORDERNO NVARCHAR2(24) NOT NULL,
  BUSINESSID  NVARCHAR2(36) NOT NULL,
  TYPE    NUMBER(1) NOT NULL,
  RECEIPTNO NVARCHAR2(64) NOT NULL,
  RECEIPTNAME NVARCHAR2(16) NOT NULL,
  BANKNAME NVARCHAR2(32),
  RPTPROVINCE NVARCHAR2(32),
  RPTCITY     NVARCHAR2(32),
  RPTAREA     NVARCHAR2(32),
  BANK2NAME   NVARCHAR2(64),
  APPENDDATA  NVARCHAR2(64),
  PAYDATE     NVARCHAR2(16) NOT NULL,
  BATCHNO     NVARCHAR2(36) NOT NULL,
  AMOUNT      NUMBER(16,2) NOT NULL,
  NOTIFYURL   NVARCHAR2(512),
  CREATTIME   DATE NOT NULL,
  FINISHTIME  DATE,
  STATUS      NUMBER(2) NOT NULL,
  MEMO        NVARCHAR2(512),
  TRANSPAYMSG NVARCHAR2(512),
  AUDITMSG    NVARCHAR2(512),
  BANKFEE     NUMBER(16,2),
  CONSTRAINTS PK_BUSINESS_WITHDRAW PRIMARY KEY(ORDERNO) USING INDEX --TABLESPACE tbs_pk_idx
);
/

--退货记录表
CREATE TABLE MB_BUSINESS_REFUND
(
  ID  NVARCHAR2(36) NOT NULL,
  USERID  NVARCHAR2(36) NOT NULL,
  ORDERNO NVARCHAR2(64) NOT NULL,
  ORDERSPAYNO NVARCHAR2(64) NOT NULL,
  BUSINESSID NVARCHAR2(36) NOT NULL,
  REFUNDID   NVARCHAR2(36) NOT NULL,
  REFUNDTYPE NUMBER(1) NOT NULL,
  TYPE    NUMBER(1),
  TRADENO NVARCHAR2(64),
  PAYDATE NVARCHAR2(16) NOT NULL,
  REFUNDTIME NVARCHAR2(16),
  BATCHNO NVARCHAR2(32),
  AMOUNT  NUMBER(16,2) NOT NULL,
  NOTIFYURL   NVARCHAR2(512),
  CREATTIME   DATE NOT NULL,
  FINISHTIME  DATE,
  STATUS      NUMBER(2) NOT NULL,
  REMARK      NVARCHAR2(64),
  REFUNDMSG   NVARCHAR2(256),
  AUDITMSG    NVARCHAR2(128),
  CONSTRAINTS PK_BUSINESS_REFUND PRIMARY KEY(ID) USING INDEX --TABLESPACE tbs_pk_idx
);
/
--支付记录表
CREATE TABLE MB_PAY
(
  ...
  ORDERSPAYNO NVARCHAR2(64) NOT NULL,
  TYPE    NUMBER(1),
  PAYDATE NVARCHAR2(16),
  PAYNO   NVARCHAR2(64),
  ORDERNAME NVARCHAR2(64),
  ORDERURL  NVARCHAR2(512),
  AMOUNT  NUMBER(16,2) NOT NULL,
  NOTIFYURL   NVARCHAR2(512) NOT NULL,
  CREATETIME   DATE NOT NULL,
  PAYTIME     DATE,
  TRADENO     NVARCHAR2(64),
  STATUS      NUMBER(1),
  REMARK      NVARCHAR2(64),
  RETURNURL   NVARCHAR2(512),
  CONSTRAINTS PK_PAY PRIMARY KEY(ID) USING INDEX --TABLESPACE tbs_pk_idx
);
/

-- 提现服务费公式记录表 MB_WITHDRAW_FORMULA
-- 删除表 DROP TABLE MB_WITHDRAW_FORMULA CASCADE CONSTRAINTS;
CREATE TABLE MB_WITHDRAW_FORMULA
(
  ID    NVARCHAR2(36) NOT NULL,
  FORMULAID  NUMBER   NOT NULL,
  MIN   NUMBER(16,2) NOT NULL,
  MAX   NUMBER(16,2) NOT NULL,
  ALPHA NUMBER(16,8) NOT NULL,
  BATE  NUMBER(16,2) NOT NULL,
  CONSTRAINTS PK_WITHDRAW_FORMULA_ID PRIMARY KEY (ID) USING INDEX TABLESPACE tbs_pk_idx
);
/

-- 活动记录表MB_ACTIVITY
-- 删除表 DROP TABLE MB_ACTIVITY CASCADE CONSTRAINTS;
CREATE TABLE MB_ACTIVITY
(
  ID    NVARCHAR2(36) NOT NULL,
  ...
  CONSTRAINTS PK_ACTIVITY_ID PRIMARY KEY (ID) USING INDEX TABLESPACE tbs_pk_idx
);
/
-- 商家账单数据总表 MB_BUSINESS_AP_TOTAL
-- 删除表 DROP TABLE MB_BUSINESS_AP_TOTAL CASCADE CONSTRAINTS;
CREATE TABLE MB_BUSINESS_AP_TOTAL
(
  ID      NVARCHAR2(36) NOT NULL,
  BUSINESSID NVARCHAR2(36) NOT NULL,
  FEE   NUMBER(16,2) NOT NULL,
  ...
  ENDDATE   DATE NOT NULL,
  TYPE      NUMBER(1) DEFAULT 0,
  CONSTRAINTS PK_BUS_AP_TOTAL_ID PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx,
  CONSTRAINTS FK_BUS_AP_TOTA_ID foreign key (BUSINESSID) REFERENCES MB_BUSINESS (ID) ON DELETE CASCADE
);
/
-- 商家账单总表 MB_BILL_TOTAL
-- 删除表 DROP TABLE MB_BILL_TOTAL CASCADE CONSTRAINTS;
CREATE TABLE MB_BILL_TOTAL
(
  ID      NVARCHAR2(36) NOT NULL,
  BUSINESSID NVARCHAR2(36) NOT NULL,
  FEE   NUMBER(16,2) NOT NULL,
  ...
  ENDDATE   DATE NOT NULL,
  TYPE      NUMBER(1) DEFAULT 0,
  CONSTRAINTS PK_BILL_TOTAL_ID PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx,
  CONSTRAINTS FK_BILL_TOTAL_ID foreign key (BUSINESSID) REFERENCES MB_BUSINESS (ID) ON DELETE CASCADE
);
/
-- 充值卡表 MB_RECHARGE_CARD
-- 删除表 DROP TABLE MB_RECHARGE_CARD CASCADE CONSTRAINTS;
/*CREATE TABLE MB_RECHARGE_CARD
(
  ID      NVARCHAR2(36) NOT NULL,
  CARDNO  NVARCHAR2(36) NOT NULL,
  AMOUNT  NUMBER(16,2)  NOT NULL,
  AREACODE NVARCHAR2(16),
  STATUS  NUMBER(1) DEFAULT 1,
  TYPE    NUMBER NOT NULL,
  CARDMNO NVARCHAR2(12),
  CONSTRAINTS PK_RECHARGE_CARD_ID PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx
  );*/
-- 充值卡使用记录表 MB_BUSINESS_AP_TOTAL
-- 删除表 DROP TABLE MB_BUSINESS_AP_TOTAL CASCADE CONSTRAINTS;
/*CREATE TABLE MB_RECHARGE_CARD_USERLOG
(
  ID      NVARCHAR2(36) NOT NULL,
  CARDNO  NVARCHAR2(36) NOT NULL,
  USERID  NVARCHAR2(36) NOT NULL,
  USERDATE DATE DEFAULT SYSDATE,
  CONSTRAINTS PK_RECHARGE_CARD_LOG_ID PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx
  );*/

CREATE TABLE MB_BUSINESS_UCLASSIFY
(
  ID      NVARCHAR2(36) not null,
  PID     NVARCHAR2(36) not null,
  CAPTION NVARCHAR2(32) not null,
  UPDATETIME DATE,
  CONSTRAINTS PK_BUSINESS_UCLASSIFY PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx
);
/

CREATE TABLE MB_BUSINESS_UCLASSIFY_RELATION
(
  BUSINESSID NVARCHAR2(36) not null,
  CLASSIFYID NVARCHAR2(36) not null,
  CONSTRAINTS PK_BUSINESS_UCLASSIFY_REL_ID  PRIMARY KEY(BUSINESSID,CLASSIFYID) USING INDEX TABLESPACE tbs_pk_idx,
  CONSTRAINTS FK_BUSINESS_UCLASSIFY_ID FOREIGN KEY (CLASSIFYID) REFERENCES MB_BUSINESS_UCLASSIFY (ID) ON DELETE CASCADE,
  CONSTRAINTS FK_MB_BUSINESS_ID  FOREIGN KEY (BUSINESSID) REFERENCES MB_BUSINESS (ID) ON DELETE CASCADE
);
/

/*CREATE TABLE MB_RECHARGE_CARD_BUSINESS --mb_recharge_card_business
(
  ID      NVARCHAR2(36) not null,
  BusinessID      NVARCHAR2(36) not null,
  CardMNoStart     NVARCHAR2(12) not null,
  CardMNoEnd NVARCHAR2(12) not null,
  CONSTRAINTS PK_recharge_card_business PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx,
  CONSTRAINTS FK_MB_BUSINESSID FOREIGN KEY (BUSINESSID) REFERENCES MB_BUSINESS (ID) ON DELETE CASCADE
);*/

-- 充值卡信息临时表 MB_USER_INFO
-- 删除表 DROP TABLE MB_REMIT_REC CASCADE CONSTRAINTS;
/*CREATE TABLE MB_RECHARGE_CARD_TEMP
(
  ID      NVARCHAR2(36) NOT NULL,
  REALID  NVARCHAR2(36) NOT NULL,
  CARDNO  NVARCHAR2(36) NOT NULL,
  CONSTRAINTS PK_ECHARGE_CARD_TEMP PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx
);*/

--用户带金卷记录表 MB_USER_VOLUME_RECORD
-- 删除表 DROP TABLE MB_USER_VOLUME_RECORD CASCADE CONSTRAINTS;
CREATE TABLE MB_USER_VOLUME_RECORD
(
  ID     NVARCHAR2(36) NOT NULL,
  USERID NVARCHAR2(36) NOT NULL,
  AMOUNTCHANGE NUMBER(16,2) NOT NULL,
  ...
  RESUME NVARCHAR2(32),
  TYPE   NUMBER(2) DEFAULT 0,
  ORDERNO NVARCHAR2(36),
  BUSINESSID NVARCHAR2(36),
  FLAGSHIPID NVARCHAR2(36),
  RETURNID   NVARCHAR2(36),
  STATUS     NUMBER(3) NOT NULL,
  CAPTION    NVARCHAR2(128),
  CONSTRAINTS PK_USER_VOLUME_RECORD PRIMARY KEY(ID) USING INDEX TABLESPACE tbs_pk_idx,
  CONSTRAINTS FK_USER_VOLUME_ID FOREIGN KEY (USERID) REFERENCES MB_USER(ID) ON DELETE CASCADE
);
/

-- 支付单表 MPAY_ORDERS
-- 删除表 DROP TABLE MPAY_ORDERS CASCADE CONSTRAINTS;
CREATE TABLE MPAY_ORDERS
(
  PAYID      NVARCHAR2(36) NOT NULL,
  PAYNO      NVARCHAR2(32) UNIQUE NOT NULL,
  AMOUNT     NUMBER(16,2) NOT NULL,
  PAYSOURCE  NUMBER(2) NOT NULL,
  CREATETIME DATE      NOT NULL,
  PAYTIME    DATE,
  NOTIFYTIME DATE,
  STATUS     NUMBER(2) NOT NULL,
  ISREFUND   NUMBER(1),
  REFUNDAMOUNT NUMBER(16,2) DEFAULT 0,
  TOKEN      NVARCHAR2(32) NOT NULL,
  CLIENT     NVARCHAR2(12) NOT NULL,
  PAYTYPE    NUMBER(2) NOT NULL,
  CONSTRAINTS PK_MPAY_ORDERS_ID PRIMARY KEY(PAYID) USING INDEX TABLESPACE tbs_pk_idx
);
/

-- 支付订单表 MPAY_ORDER_DETAIL
-- 删除表 DROP TABLE MPAY_ORDERS_DETAIL CASCADE CONSTRAINTS;
CREATE TABLE MPAY_ORDER_DETAIL
(
  ODID      NVARCHAR2(36) NOT NULL,
  PAYNO     NVARCHAR2(32) NOT NULL,
  ORDERNO   NVARCHAR2(32) NOT NULL,
  AMOUNT    NUMBER(16,2) NOT NULL,
  CONSTRAINTS PK_MPAY_ORDER_DETAIL PRIMARY KEY(ODID) USING INDEX TABLESPACE tbs_pk_idx
);
/